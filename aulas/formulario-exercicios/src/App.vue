  ...
  <div id="app">
    ...
    <div class="conteudo">
      <form class="painel">
        ...
        <Rotulo nome="Senha">
          <input type="password" v-mode="usuario.password" />
        </Rotulo>
        <Rotulo nome="Idade">
        ...
        <Rotulo nome="Qual produto?">
          <span class="mr-4">
            <input type="radio" value="web" v-model="produtoSelecionado" /> Web
          </span>
          <span class="mr-4">
            <input type="radio" value="Mobile" v-model="produtoSelecionado" /> Mobile
          </span>
          <span>
            <input type="radio" value="Outro" v-model="produtoSelecionado" /> Outro
          </span>
        </Rotulo>
